...
| Text | Position validation; no shaper selected | Published `Milky2018/moon_cosmic@0.3.3` plus pinned source comparison | Japanese/emoji/fallback, shaping and editing positions | Font-backed Japanese layout and CPU glyph output passed | Same probe passed in WasmGC; upstream tests 294/294 JS and WasmGC; no browser integration | GPU upload, fallback and input integration still required | [Font-backed evaluation](text-layout.md) |
